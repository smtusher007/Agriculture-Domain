      ...
      <?php
        ...
        if($userQuery->num_rows > 0)
        {
          ...
          { $id = $row['id'];
            ...
            echo "<td> <a href='../view/update-food-item.php?product_id=$product_id' class='link-hvr'>Edit</a> <br> <a href='../control/delete-foodControl.php?food_id=$id' class='link-hvr'>Delete</a> </td>";
            echo "</tr>";
          }
          echo "</table>";
          $conn->close();
