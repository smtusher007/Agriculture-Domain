...
class db
{
	...
	function BookingInsert($conn,$table,$productsname,$totalweight,$phone,$pdate,$message)
	{
		$stmt = $conn -> prepare("INSERT INTO $table (productsname, totalweight, phone, pdate, message) VALUES (?, ?, ?, ?, ?)");
		$stmt -> bind_param("sssss",$productsname,$totalweight,$phone,$pdate,$message);
		$stmt -> execute();  
		return $stmt; 
